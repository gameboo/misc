...
Assuming all tools are installed and the disk images and filenames match, run the following commands to prepare the RISCV FPGA image and bring up FreeBSD on the DE10Pro's ARM HPS system:
